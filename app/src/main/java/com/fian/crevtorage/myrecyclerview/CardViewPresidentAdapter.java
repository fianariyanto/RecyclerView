    ...
    public void onBindViewHolder(CardViewViewHolder holder, int position) {
        ...
        holder.btnDetail.setOnClickListener(new CustomOnItemClickListener(position, new CustomOnItemClickListener.OnItemClickCallback() {
            ...
            public void onItemClicked(View view, int position) {
                ...
                Intent intent = new Intent(context, DetailPresidentAdapter.class);
                intent.putExtra("name",getListPresident().get(position).getName());
                intent.putExtra("remarks",getListPresident().get(position).getRemarks());
                intent.putExtra("photo",getListPresident().get(position).getPhoto());
                intent.putExtra("nationality",getListPresident().get(position).getNationality());
                intent.putExtra("desc",getListPresident().get(position).getDesc());
